...
const library = [
    {title: "The Silent Patient", author: "Deo Seth Jabagat", pageCount: 45, readStatus: false}, 
    {title: "What the Hell", author: "Mark Pratesh", pageCount: 512, readStatus: true}];
...
function createCard(book) {
    ...
    // btnContainer.classList.add("card-actions justify-end mt-5");
    ...
    // card.classList.add("card w-96 bg-base-200 shadow-xl");
